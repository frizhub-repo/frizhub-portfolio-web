      ...
      <div className={styles.container}>
        ...
        <div className={styles.motiveTextContainer}>
          <p className={styles.motiveText}>
            Every product is unique, but so is also our tailored process: we
            fuse strategy, creation and engineering. To genuinely innovate, we
            foster synergies beyond the established.
          </p>
        </div>
      </div>
    </Fade>
